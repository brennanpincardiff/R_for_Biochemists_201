...
The material provided includes text to read, video demonstrations, an example R script with exercises. We hope you enjoy the modules. We welcome feedback and comments. 
...
Output can be changed at a later date. 
...
It is the 8th sheet in this file. 
...
Or you can make it with ggscatter() but you will need to modify the y-axis
...
##### Third video - output in HTML, output in Word, et al... 
Explore the various options in the Knit button above. 
HTML and Word are relatively easily on most computers. 
Getting PDFs to work requires an installation of something else. 

You can also make presentations - check out this file for Isoslides
Check out this source for information on Beamer. 
I would encourage you to be creative. 

pagebreak \pagebreak

### Exercise 3
Create and share your R journey if you are willing. 
...
### Resources
* You could move onto Module 4 - Multi-panel figures
